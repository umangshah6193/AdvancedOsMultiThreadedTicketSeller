...
public abstract class MainSeller implements Runnable {
	...
	//String type;
	protected Seat[][] seatingArrangement;
	Object threadLock;

	public MainSeller(Seat[][] s, int serviceTime, String sellerID, Object lk) {
